...
const Reviews = () => {
  return (
    ...
    <section className="max-w-7xl mx-auto border-b-2 border-b-black text-TermTxtGld" id="reviews">
        <div className="border-y-black mb-20">
            ...
            <div className="flex flex-wrap justify-center">
              {REVIEWS.reviews.map((review, index) => (
                <div key={index} className="mt-10 flex flex-col items-center justify-center rounded-2xl border border-TermTxtGld p-10 mx-2 max-w-xs">
